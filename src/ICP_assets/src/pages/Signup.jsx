    ...
    return (
        <div style = {{ textAlign : "center", paddingTop : "200px"}}>
            ...
            <form action = "#">
                ...
                <div style = {{paddingTop : "20px"}}>
                    <button type="submit" onClick = {Submit} style = {{ width : "200px", height : "30px", backgroundColor : "#0E86D4", color : "white", fontSize : "15px"}} >Sign Up</button>
                </div>
            </form>
            <div style = {{paddingTop : "20px"}}>
                <button type="button" onClick = {Login} style = {{ width : "200px", height : "30px", backgroundColor : "#04AA6D", color : "white", fontSize : "15px"}} >Login</button>
            </div>
        </div>
    );
}
